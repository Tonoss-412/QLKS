...
public class MENU_FORM extends javax.swing.JFrame {
    ...
    public void hienThiDanhSachNhanVien() {
        ...
        JTableHeader tableHeader = jTableNhanvien.getTableHeader();
     ...
     public ArrayList<KhachHang> layDanhSachKhachHang() {
        ...
        try {
            ...
            KhachHang kh;
            while (rs.next()) {
                kh = new KhachHang(rs.getString("MAKH"), rs.getString("TENKH"), rs.getString("CMND"), rs.getString("QUOCTICH"), rs.getString("GIOITINH"), rs.getDate("NGAYSINH"), rs.getString("SDT"), rs.getString("MAPHONG") );
     ...
     public void hienThiDanhSachKhachHang() {
        String colTieuDe1[] = new String[]{"Mã Khách Hàng", "Tên Khách Hàng", "Chứng Minh Nhân Dân", "Quốc Tịch", "Giới Tính", "Ngày sinh", "Số Điện Thoại", "Mã Phòng"};
        ...
        JTableHeader tableHeader = jTableKhachhang.getTableHeader();
        Font headerFont = new Font("Verdana", Font.PLAIN, 18);
        tableHeader.setFont(headerFont);
    ...
    public void hienThiDanhSachDichVu() {
        ...
        JTableHeader tableHeader = jTableDichvu.getTableHeader();
        Font headerFont = new Font("Verdana", Font.PLAIN, 18);
        tableHeader.setFont(headerFont);
    ...
    public void hienThiDanhSachPhong() {
        ...
        JTableHeader tableHeader = jTablePHONG.getTableHeader();
        Font headerFont = new Font("Verdana", Font.PLAIN, 18);
        tableHeader.setFont(headerFont);
    ...
    public ArrayList<HoaDon> layDanhSachHoaDon() {
     ...
     public void hienThiDanhSachHoaDon() {
        ...
        JTableHeader tableHeader = jTableHOADON.getTableHeader();
        Font headerFont = new Font("Verdana", Font.PLAIN, 18);
        tableHeader.setFont(headerFont);
    ...
    private void initComponents() {
        ...
        jLabel31.setFont(new java.awt.Font("Calibri", 1, 50)); // NOI18N
        jLabel31.setText("DANH SÁCH HÓA ĐƠN");

        jTableHOADON.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jTableHOADON.setForeground(new java.awt.Color(51, 51, 51));
        ...
        jTableHOADON.setToolTipText("");
        jTableHOADON.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        jPanel20Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel20Layout.createSequentialGroup()
                .addGroup(jPanel20Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel20Layout.createSequentialGroup()
                        .addGap(350, 350, 350)
                        .addComponent(jLabel31, javax.swing.GroupLayout.PREFERRED_SIZE, 498, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel21.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Thông Tin Hóa Đơn", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 24))); // NOI18N
        ...
        them4.setFont(new java.awt.Font("Segoe UI Semibold", 3, 18)); // NOI18N
        them4.setText("Thêm");
        them4.setMinimumSize(new java.awt.Dimension(83, 33));
        them4.setPreferredSize(new java.awt.Dimension(83, 33));
        ...
        sua4.setFont(new java.awt.Font("Segoe UI Semibold", 3, 18)); // NOI18N
        sua4.setText("Sửa");
        ...
        xoa4.setFont(new java.awt.Font("Segoe UI Semibold", 3, 18)); // NOI18N
        xoa4.setText("Xóa");
        xoa4.setPreferredSize(new java.awt.Dimension(83, 33));
        ...
        thoat4.setFont(new java.awt.Font("Segoe UI Symbol", 3, 18)); // NOI18N
        thoat4.setForeground(new java.awt.Color(255, 51, 51));
        ...
        jButtonclear4.setFont(new java.awt.Font("Segoe UI Semibold", 3, 18)); // NOI18N
                ...
                .addGroup(jPanel21Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel21Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(jPanel21Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(xoa4, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 85, Short.MAX_VALUE)
                            .addComponent(them4, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 85, Short.MAX_VALUE))))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 25, Short.MAX_VALUE)
                .addGroup(jPanel21Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(jTextFieldMAHD)
                    .addComponent(jTextFieldMANVHD, javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jTextFieldMAPHONGHD, javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel21Layout.createSequentialGroup()
                        .addComponent(sua4, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(44, 44, 44)
                        .addComponent(jButtonclear4, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(thoat4, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jTextFieldGIAHD, javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jTextFieldNGAY, javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel21Layout.setVerticalGroup(
            ...
            .addGroup(jPanel21Layout.createSequentialGroup()
                ...
                .addGroup(jPanel21Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(them4, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(sua4)
                    .addComponent(jButtonclear4))
                .addGap(30, 30, 30)
                .addGroup(jPanel21Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(xoa4, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(thoat4))
                .addGap(26, 26, 26)
                .addGroup(jPanel21Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jPanel20, javax.swing.GroupLayout.PREFERRED_SIZE, 500, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(8, 8, 8)
        ...
        jTableNhanvien.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        jPanel9.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Thông Tin Nhân Viên", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 24))); // NOI18N
        ...
        them.setFont(new java.awt.Font("Segoe UI Semibold", 3, 18)); // NOI18N
        them.setText("Thêm");
        ...
        sua.setFont(new java.awt.Font("Segoe UI Semibold", 3, 18)); // NOI18N
        sua.setText("Sửa");
        ...
        xoa.setFont(new java.awt.Font("Segoe UI Semibold", 3, 18)); // NOI18N
        xoa.setText("Xóa");
        ...
        thoat.setFont(new java.awt.Font("Segoe UI Symbol", 3, 18)); // NOI18N
        ...
        jButtonclear.setFont(new java.awt.Font("Segoe UI Semibold", 3, 18)); // NOI18N
                ...
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel9Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(jTextFieldCHUTHICH, javax.swing.GroupLayout.PREFERRED_SIZE, 198, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel9Layout.createSequentialGroup()
                        .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jTextFieldTENNV, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 198, Short.MAX_VALUE)
                            .addComponent(jTextFieldCHUCVU, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jTextFieldLUONG, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jTextFieldMANV)))
                    .addGroup(jPanel9Layout.createSequentialGroup()
                        .addGap(24, 24, 24)
                        .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(them, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel12.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Thông Tin Khách Hàng", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 24))); // NOI18N
        ...
        them1.setFont(new java.awt.Font("Segoe UI Semibold", 3, 18)); // NOI18N
        them1.setText("Thêm");
        ...
        sua1.setFont(new java.awt.Font("Segoe UI Semibold", 3, 18)); // NOI18N
        sua1.setText("Sửa");
        ...
        xoa1.setFont(new java.awt.Font("Segoe UI Semibold", 3, 18)); // NOI18N
        xoa1.setText("Xóa");
        ...
        thoat1.setFont(new java.awt.Font("Segoe UI Symbol", 3, 18)); // NOI18N
        thoat1.setForeground(new java.awt.Color(255, 51, 51));
        ...
        jButtonclear2.setFont(new java.awt.Font("Segoe UI Semibold", 3, 18)); // NOI18N
                ...
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel12Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jTextFieldTENKH, javax.swing.GroupLayout.DEFAULT_SIZE, 137, Short.MAX_VALUE)
                    ...
                    .addGroup(jPanel12Layout.createSequentialGroup()
                        .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(them1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 83, Short.MAX_VALUE)
                        ...
                        .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel12Layout.createSequentialGroup()
                                ...
                                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            .addGroup(jPanel12Layout.createSequentialGroup()
                                .addComponent(sua1, javax.swing.GroupLayout.DEFAULT_SIZE, 84, Short.MAX_VALUE)
                                .addGap(29, 29, 29)
                                .addComponent(jButtonclear2, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(72, 72, 72))))))
        ...
        jLabel9.setFont(new java.awt.Font("Calibri", 1, 50)); // NOI18N
        jLabel9.setText("DANH SÁCH KHÁCH HÀNG");

        jTableKhachhang.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        jPanel11Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel11Layout.createSequentialGroup()
                ...
                .addContainerGap(2752, Short.MAX_VALUE))
        );
        ...
        jPanel18.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Thông Tin Phòng", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 24))); // NOI18N
        jPanel18.setToolTipText("");
        jPanel18.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jPanel18.setFont(new java.awt.Font("Tahoma", 0, 5)); // NOI18N
        ...
        jTextFieldMAPHONG.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextFieldMAPHONGActionPerformed(evt);
            }
        });

        jTextFieldTENPHONG.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextFieldTENPHONGActionPerformed(evt);
            }
        });

        jTextFieldCHUTHICHP.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextFieldCHUTHICHPActionPerformed(evt);
            }
        });
        ...
        them3.setFont(new java.awt.Font("Segoe UI Semibold", 3, 18)); // NOI18N
        them3.setText("Thêm");
        ...
        sua3.setFont(new java.awt.Font("Segoe UI Semibold", 3, 18)); // NOI18N
        sua3.setText("Sửa");
        ...
        xoa3.setFont(new java.awt.Font("Segoe UI Semibold", 3, 18)); // NOI18N
        xoa3.setText("Xóa");
        ...
        thoat3.setBackground(new java.awt.Color(204, 204, 204));
        thoat3.setFont(new java.awt.Font("Segoe UI Symbol", 3, 18)); // NOI18N
        thoat3.setForeground(new java.awt.Color(255, 51, 51));
        ...
        jButtonclear3.setFont(new java.awt.Font("Segoe UI Semibold", 3, 18)); // NOI18N
            ...
            .addGroup(jPanel18Layout.createSequentialGroup()
                .addGroup(jPanel18Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel18Layout.createSequentialGroup()
                        .addContainerGap()
                        .addGroup(jPanel18Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(xoa3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(them3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGap(35, 35, 35)
                .addGroup(jPanel18Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel18Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(jTextFieldMAPHONG, javax.swing.GroupLayout.Alignment.TRAILING)
                        .addComponent(jTextFieldMADVP, javax.swing.GroupLayout.DEFAULT_SIZE, 183, Short.MAX_VALUE)
                        ...
                        .addComponent(jTextFieldTENPHONG, javax.swing.GroupLayout.Alignment.TRAILING))
                    .addComponent(jTextField3, javax.swing.GroupLayout.PREFERRED_SIZE, 184, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel18Layout.createSequentialGroup()
                        .addGroup(jPanel18Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(thoat3, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(sua3, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(38, 38, 38)
                        .addComponent(jButtonclear3, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel18Layout.setVerticalGroup(
            ...
            .addGroup(jPanel18Layout.createSequentialGroup()
                ...
                .addGroup(jPanel18Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jTextFieldMADVP, javax.swing.GroupLayout.DEFAULT_SIZE, 27, Short.MAX_VALUE))
        ...
        jLabel22.setFont(new java.awt.Font("Calibri", 1, 50)); // NOI18N
        jLabel22.setText("DANH SÁCH PHÒNG");

        jTablePHONG.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        ...
        jTablePHONG.setMinimumSize(new java.awt.Dimension(68, 72));
        jTablePHONG.setRowHeight(25);
        ...
        jPanel18.getAccessibleContext().setAccessibleName("Thông tin phòng");
        ...
        jPanel15.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Thông Tin Dịch Vụ", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 24))); // NOI18N
        ...
        them2.setFont(new java.awt.Font("Segoe UI Semibold", 3, 18)); // NOI18N
        them2.setText("Thêm");
        ...
        sua2.setFont(new java.awt.Font("Segoe UI Semibold", 3, 18)); // NOI18N
        sua2.setText("Sửa");
        ...
        xoa2.setFont(new java.awt.Font("Segoe UI Semibold", 3, 18)); // NOI18N
        xoa2.setText("Xóa");
        ...
        thoat2.setFont(new java.awt.Font("Segoe UI Symbol", 3, 18)); // NOI18N
        thoat2.setForeground(new java.awt.Color(255, 51, 51));
        ...
        jButtonclear1.setFont(new java.awt.Font("Segoe UI Semibold", 3, 18)); // NOI18N
                            ...
                            .addGroup(jPanel15Layout.createSequentialGroup()
                                .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(them2, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(25, 25, 25)
                                .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jTableDichvu.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        jLabel18.setFont(new java.awt.Font("Calibri", 1, 50)); // NOI18N
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel7Layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(jLabel18, javax.swing.GroupLayout.PREFERRED_SIZE, 470, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(283, 283, 283)))
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jTabbedPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 773, Short.MAX_VALUE)
        );
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        for (int i = 0; i < dsnv.size(); i++) {
            row = new Object[7];
            if(dsnv.get(i).getMANV().equals(text)) {
                row[0] = dsnv.get(i).getMANV();
                row[1] = dsnv.get(i).getTENNV();
                row[2] = dsnv.get(i).getCHUCVU();
                row[3] = dsnv.get(i).getLUONGNV();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        for (int i = 0; i < dshd.size(); i++) {
            ...
            // GÁN GIÁ TRỊ
            if(dshd.get(i).getMAHD().equals(text))
            {
                row[0] = dshd.get(i).getMAHD();
                row[1] = dshd.get(i).getMANV();
                row[2] = dshd.get(i).getMAPHONG();
...
//        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        for (int i = 0; i < dsp.size(); i++) {
            row = new Object[8];
            if(dsp.get(i).getMAPHONG().equals(text)) {
                row[0] = dsp.get(i).getMAPHONG();
                row[1] = dsp.get(i).getTENPHONG();
                row[2] = dsp.get(i).getLOAIPHONG();
                row[3] = dsp.get(i).getGIAPHONG();
    ...
    private void jTextFieldCHUTHICHPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldCHUTHICHPActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextFieldCHUTHICHPActionPerformed

    private void jTextFieldTENPHONGActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldTENPHONGActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextFieldTENPHONGActionPerformed

    private void jTextFieldMAPHONGActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldMAPHONGActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextFieldMAPHONGActionPerformed
    ...
    private void jTableKhachhangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableKhachhangMouseClicked
        ...
        jTextFieldNGAYSINH.setText(model.getValueAt(i, 5).toString());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for (int i = 0; i < dsdv.size(); i++) {
            row = new Object[3];
            if(dsdv.get(i).getMADV().equals(text)){
                row[0] = dsdv.get(i).getMADV();
                row[1] = dsdv.get(i).getTENNVL();
                row[2] = dsdv.get(i).getGIADV();
            }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        for (int i = 0; i < dskh.size(); i++) {
            row = new Object[8];
            if(dskh.get(i).getMAKH().equals(text)) {
                row[0] = dskh.get(i).getMAKH();
                row[1] = dskh.get(i).getTENKH();
                row[2] = dskh.get(i).getCMND();
                row[3] = dskh.get(i).getQUOCTICH();
            ...
            if(dskh.get(i).getCMND().equals(text)) {
                row[0] = dskh.get(i).getMAKH();
                row[1] = dskh.get(i).getTENKH();
                row[2] = dskh.get(i).getCMND();
                row[3] = dskh.get(i).getQUOCTICH();
    ...
    private void sua1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sua1ActionPerformed
        ...
        if (jTableKhachhang.getSelectedRow()==-1) {
            ...
            model.setValueAt(jTextFieldNGAYSINH.getText(), jTableKhachhang.getSelectedRow(), 5);
    ...
    private void them1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_them1ActionPerformed
        ...
        try {
            // Tạo một đối tượng để thực hiện công việc
            st = (Statement) con.createStatement();
            String query = "INSERT INTO khachhang(MAKH,TENKH, CMND, QUOCTICH, GIOITINH, NGAYSINH, SDT, MAPHONG) VALUES('" + jTextFieldMAKH.getText() + "',"
            + "'" + jTextFieldTENKH.getText() + "','" + jTextFieldCMND.getText() + "', '" + jTextFieldQUOCTICH.getText() + "', '" + jTextFieldGIOITINHKH.getText() + "', '" + jTextFieldNGAYSINH.getText() + "', '" + jTextFieldSDT.getText() + "', '" + jTextFieldMAPHONGKH.getText() + "')";
